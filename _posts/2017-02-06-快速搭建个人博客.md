...
> 
> [我的的博客](https://shanzeii.github.io/)

# 前言
从 Jekyll 到 GitHub Pages 中间踩了许多坑，终于把我的个人博客[BY Blog](https://shanzeii.github.io/)搭建出来了。。。
...
注册完成后搜索 `shanzeii.github.io` 进入[我的仓库](https://github.com/shanzeii/shanzeii.github.io)
